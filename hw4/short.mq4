...
extern string SymbolToTrade = "GBPCHF"; // Currency pair to trade
...
//+------------------------------------------------------------------+
//| Open Short GBPCHF order                                          |
//+------------------------------------------------------------------+
void OpenShortGBPCHFOrder()
{
    double lotSize = CalculateLotSize(TradeVolume);

    // Open a Sell position
    int ticket = OrderSend(SymbolToTrade, OP_SELL, lotSize, Bid, 3, 0, 0, "Short GBPCHF Hourly", 0, 0, clrRed);
